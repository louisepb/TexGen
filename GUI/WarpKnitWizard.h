...
//class CWarpKnitWizard : public wxWizard
//{
//public:
//
//	CWarpKnitWizard(wxWindow* parent, wxWindowID id = wxID_ANY);
//	~CWarpKnitWizard(void);
//
//	bool RunIt();
//	string GetCreateTextileCommand(string ExistingTextile = "");
//	void LoadSettings(const CTextileWarpKnit &WeftKnit);
//
//protected:
//	
