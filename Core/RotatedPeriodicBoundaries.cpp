...
void CRotatedPeriodicBoundaries::OutputEquations( ostream& Output, int iBoundaryConditions )
{
	...
	Output << "ConstraintsDriver3, 1, <xx>, ConstraintsDriver4, 1, <xx>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceA, 2, 1.0, FaceB, 2, -1.0, ConstraintsDriver3, 1, <xy>" << endl;
	Output << "ConstraintsDriver1, 1, <xy>, ConstraintsDriver5, 1, <xy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceA, 3, 1.0, FaceB, 3, -1.0, ConstraintsDriver4, 1, <xz>" << endl;
	Output << "ConstraintsDriver5, 1, <xz>, ConstraintsDriver2, 1, <xz>" << endl;

	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceC, 1, 1.0, FaceD, 1, -1.0, ConstraintsDriver0, 1, <yx>" << endl;
	Output << "ConstraintsDriver3, 1, <yx>, ConstraintsDriver4, 1, <yx>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceC, 2, 1.0, FaceD, 2, -1.0, ConstraintsDriver3, 1, <yy>" << endl;
	Output << "ConstraintsDriver1, 1, <yy>, ConstraintsDriver5, 1, <yy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceC, 3, 1.0, FaceD, 3, -1.0, ConstraintsDriver4, 1, <yz>" << endl;
	Output << "ConstraintsDriver5, 1, <yz>, ConstraintsDriver2, 1, <yz>" << endl;

	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceE, 1, 1.0, FaceF, 1, -1.0, ConstraintsDriver0, 1, <zx>" << endl;
	Output << "ConstraintsDriver3, 1, <zx>, ConstraintsDriver4, 1, <zx>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceE, 2, 1.0, FaceF, 2, -1.0, ConstraintsDriver3, 1, <zy>" << endl;
	Output << "ConstraintsDriver1, 1, <zy>, ConstraintsDriver5, 1, <zy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "FaceE, 3, 1.0, FaceF, 3, -1.0, ConstraintsDriver4, 1, <zz>" << endl;
	Output << "ConstraintsDriver5, 1, <zz>, ConstraintsDriver2, 1, <zz>" << endl;

	Output << "************************************************" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge2, 1, 1.0, Edge1, 1, -1.0, ConstraintsDriver0, 1, <xx>" << endl;
	Output << "ConstraintsDriver3, 1, <xx>, ConstraintsDriver4, 1, <xx>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge2, 2, 1.0, Edge1, 2, -1.0, ConstraintsDriver3, 1, <xy>" << endl;
	Output << "ConstraintsDriver1, 1, <xy>, ConstraintsDriver5, 1, <xy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge2, 3, 1.0, Edge1, 3, -1.0, ConstraintsDriver4, 1, <xz>" << endl;
	Output << "ConstraintsDriver5, 1, <xz>, ConstraintsDriver2, 1, <xz>" << endl;

	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge3, 1, 1.0, Edge1, 1, -1.0, ConstraintsDriver0, 1, <xx>" << endl;
	Output << "ConstraintsDriver3, 1, <xx>, ConstraintsDriver4, 1, <xx>" << endl;
	Output << "ConstraintsDriver0, 1, <yx>" << endl;
	Output << "ConstraintsDriver3, 1, <yx>, ConstraintsDriver4, 1, <yx>" << endl;
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge3, 2, 1.0, Edge1, 2, -1.0, ConstraintsDriver3, 1, <xy>" << endl;
	Output << "ConstraintsDriver1, 1, <xy>, ConstraintsDriver5, 1, <xy>" << endl;
	Output << "ConstraintsDriver3, 1, <yy>" << endl;
	Output << "ConstraintsDriver1, 1, <yy>, ConstraintsDriver5, 1, <yy>" << endl;
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge3, 3, 1.0, Edge1, 3, -1.0, ConstraintsDriver4, 1, <xz>" << endl;
	Output << "ConstraintsDriver5, 1, <xz>, ConstraintsDriver2, 1, <xz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge4, 1, 1.0, Edge1, 1, -1.0, ConstraintsDriver0, 1, <yx>" << endl;
	Output << "ConstraintsDriver3, 1, <yx>, ConstraintsDriver4, 1, <yx>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge4, 2, 1.0, Edge1, 2, -1.0, ConstraintsDriver3, 1, <yy>" << endl;
	Output << "ConstraintsDriver1, 1, <yy>, ConstraintsDriver5, 1, <yy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge4, 3, 1.0, Edge1, 3, -1.0, ConstraintsDriver4, 1, <yz>" << endl;
	Output << "ConstraintsDriver5, 1, <yz>, ConstraintsDriver2, 1, <yz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge6, 2, 1.0, Edge5, 2, -1.0, ConstraintsDriver3, 1, <xy>" << endl;
	Output << "ConstraintsDriver1, 1, <xy>, ConstraintsDriver5, 1, <xy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge6, 3, 1.0, Edge5, 3, -1.0, ConstraintsDriver4, 1, <xz>" << endl;
	Output << "ConstraintsDriver5, 1, <xz>, ConstraintsDriver2, 1, <xz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge7, 2, 1.0, Edge5, 2, -1.0, ConstraintsDriver3, 1, <xy>" << endl;
	Output << "ConstraintsDriver1, 1, <xy>, ConstraintsDriver5, 1, <xy>" << endl;
	Output << "ConstraintsDriver3, 1, <zy>" << endl;
	Output << "ConstraintsDriver1, 1, <zy>, ConstraintsDriver5, 1, <zy>" << endl;
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge7, 3, 1.0, Edge5, 3, -1.0, ConstraintsDriver4, 1, <xz>" << endl;
	Output << "ConstraintsDriver5, 1, <xz>, ConstraintsDriver2, 1, <xz>" << endl;
	Output << "ConstraintsDriver4, 1, <zz>" << endl;
	Output << "ConstraintsDriver5, 1, <zz>, ConstraintsDriver2, 1, <zz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge8, 2, 1.0, Edge5, 2, -1.0, ConstraintsDriver3, 1, <zy>" << endl;
	Output << "ConstraintsDriver1, 1, <zy>, ConstraintsDriver5, 1, <zy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge8, 3, 1.0, Edge5, 3, -1.0, ConstraintsDriver4, 1, <zz>" << endl;
	Output << "ConstraintsDriver5, 1, <zz>, ConstraintsDriver2, 1, <zz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge10, 2, 1.0, Edge9, 2, -1.0, ConstraintsDriver3, 1, <yy>" << endl;
	Output << "ConstraintsDriver1, 1, <yy>, ConstraintsDriver5, 1, <yy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge10, 3, 1.0, Edge9, 3, -1.0, ConstraintsDriver4, 1, <yz>" << endl;
	Output << "ConstraintsDriver5, 1, <yz>, ConstraintsDriver2, 1, <yz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge11, 2, 1.0, Edge9, 2, -1.0, ConstraintsDriver3, 1, <yy>" << endl;
	Output << "ConstraintsDriver1, 1, <yy>, ConstraintsDriver5, 1, <yy>" << endl;
	Output << "ConstraintsDriver3, 1, <zy>" << endl;
	Output << "ConstraintsDriver1, 1, <zy>, ConstraintsDriver5, 1, <zy>" << endl;
	Output << "*Equation" << endl;
	Output << "8" << endl;
	Output << "Edge11, 3, 1.0, Edge9, 3, -1.0, ConstraintsDriver4, 1, <yz>" << endl;
	Output << "ConstraintsDriver5, 1, <yz>, ConstraintsDriver2, 1, <yz>" << endl;
	Output << "ConstraintsDriver4, 1, <zz>" << endl;
	Output << "ConstraintsDriver5, 1, <zz>, ConstraintsDriver2, 1, <zz>" << endl;
	...
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge12, 2, 1.0, Edge9, 2, -1.0, ConstraintsDriver3, 1, <zy>" << endl;
	Output << "ConstraintsDriver1, 1, <zy>, ConstraintsDriver5, 1, <zy>" << endl;
	Output << "*Equation" << endl;
	Output << "5" << endl;
	Output << "Edge12, 3, 1.0, Edge9, 3, -1.0, ConstraintsDriver4, 1, <zz>" << endl;
	Output << "ConstraintsDriver5, 1, <zz>, ConstraintsDriver2, 1, <zz>" << endl;
