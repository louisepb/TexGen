...
Section "TexGen (required)" ;No components page, name is not important
  ...
  File msvcp90.dll  
  File msvcr90.dll
  File msvcr71.dll   ; Need 71 files while using OpenCascade built with vc2005
  File msvcp71.dll
  File ..\Docs\TexGen.chm
  File TexGenGUi.exe.manifest
  File Python27\Python27.dll  ; Copy dll anyway in case subversion TexGen is compiled with doesn't match version already installed
